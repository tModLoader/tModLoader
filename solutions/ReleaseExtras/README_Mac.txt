...
Manual installation:
Make a 'tModLoader' folder somewhere and place the .zip contents in it. Launch the provided 'tModLoader' file instead of the regular one.
...
Run tModLoader:
Just launch the provided tModLoader file (tModLoader.app/Contents/MacOS/tModLoader) or launch through Steam. If you see Mods or Mod Browser on the main menu in Terraria, you have successfully installed tModLoader.
