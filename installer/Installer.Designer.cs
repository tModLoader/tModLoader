namespace Installer
{
	partial class Installer
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolTip.SetToolTip(this.setup, "Developer use only. Creates resources necessary for installation.");
			...
			this.DragEnter += new System.Windows.Forms.DragEventHandler(this.DragFile);
