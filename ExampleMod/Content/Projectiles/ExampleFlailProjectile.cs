...
{
	// Example Flail is a complete adaption of Ball O' Hurt projectile. The code has been rewritten a bit to make it easier to follow. Compare this code against the decompiled Terraria code for an example of adapting vanilla code. A few comments and extra code snippets show features from other vanilla flails as well.
	// Example Flail shows a plethora of advanced AI and collision topics.
	public class ExampleFlailProjectile : ModProjectile
	{
		private const string ChainTexturePath = "ExampleMod/Content/Projectiles/ExampleFlailProjectileChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "ExampleMod/Content/Projectiles/ExampleFlailProjectileChainExtra";  // This texture and related code is optional and used for a unique effect
		...
		public override void SetDefaults() {
			Projectile.netImportant = true; // TODO: Test this, explain this?
