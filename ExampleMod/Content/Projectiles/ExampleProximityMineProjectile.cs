		...
		public override void AI() {
			...
			if (Projectile.owner == Main.myPlayer && Projectile.timeLeft <= 3) {
				...
				// Otherwise make it opaque and spawn a bunch of smoke dusts.
					...
					Dust smokeDust = Dust.NewDustDirect(new Vector2(Projectile.position.X + 3f, Projectile.position.Y + 3f) - Projectile.velocity * 0.5f, Projectile.width - 8, Projectile.height - 8, DustID.Smoke, 0f, 0f, 100);
					smokeDust.scale *= 1.6f + (float)Main.rand.Next(5) * 0.1f;
