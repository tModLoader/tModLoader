...
namespace ExampleMod.Content.Items.Weapons
{
	public class ExampleModifiedProjectilesItem : ModItem
	{
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack) {
			...
			int projectileID = Projectile.NewProjectile(player.GetProjectileSource_Item_WithPotentialAmmo(this, AmmoID.Bullet), position, new Vector2(speedX, speedY), type, damage, knockBack, player.whoAmI);
