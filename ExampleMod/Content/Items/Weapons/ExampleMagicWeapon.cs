...
namespace ExampleMod.Content.Items.Weapons
{
	public class ExampleMagicWeapon : ModItem
	{
		...
		public override void SetDefaults() {
			item.damage = 25;
			item.DamageType = DamageClassLoader.Magic; // Makes the damage register as magic. If your item does not have any damage type, it becomes true damage (which means that damage scalars will not affect it). Be sure to have a damage type.
			item.width = 34;
			item.height = 40;
			item.useTime = 20;
