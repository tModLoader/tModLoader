...
namespace ExampleMod.Content.Items.Weapons
{
	public class ExampleSword : ModItem
	{
		...
		public override void AddRecipes() {
			CreateRecipe() //This creates a new ModRecipe, associated with the mod that this content piece comes from.
				...
				.AddRecipe();								//When you're done, call this to register the recipe.
		}
