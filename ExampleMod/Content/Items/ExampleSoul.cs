...
namespace ExampleMod.Content.Items
{
	public class ExampleSoul : ModItem
	{
		public override void SetStaticDefaults() {
			...
			ItemID.Sets.AnimatesAsSoul[item.type] = true; // auto defines the item having 4 frames.
		...
		public override void PostUpdate() => Lighting.AddLight(item.Center, Color.WhiteSmoke.ToVector3() * 0.55f * Main.essScale); // make this item glow when thrown out of inventory
	}
