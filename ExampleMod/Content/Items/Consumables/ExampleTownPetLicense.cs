		...
		public override void OnConsumeItem(Player player)
		{
			...
			if (player.whoAmI == Main.myPlayer && player.itemAnimation > 0)
			{
				...
				if (!ExampleTownPetSystem.boughtExampleTownPet || NPC.AnyNPCs(npcType))
				{
					...
					TutorialTownPetUnlockOrExchangePet(ref ExampleTownPetSystem.boughtExampleTownPet, npcType, "Mods.ExampleMod.UI.LicenseExampleTownPetUse"); // Modified NPC.UnlockOrExchangePet method.
				}
			}
		}
