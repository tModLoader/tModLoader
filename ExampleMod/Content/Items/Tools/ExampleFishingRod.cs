...
namespace ExampleMod.Content.Items
{
	public class ExampleFishingRod : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.ExampleBobber>();
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int index = 0; index < bobberAmount; ++index)
			{
				...
				Projectile.NewProjectile(player.GetProjectileSource_Item(Item), position.X, position.Y, SpeedX, SpeedY, type, 0, 0f, player.whoAmI, 0f, 0f);
			}
			return false;
		}
