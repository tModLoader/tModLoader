...
namespace ExampleMod.Content.Items.Tools
{
	public class ExampleHamaxe : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.SetToolPower(ToolType.Axe, 30); //How much axe power the tool has, note that the axe power displayed in-game is this value multiplied by 5
			Item.SetToolPower(ToolType.HammerBlock, 100); //How much hammer power the tool has. Note that this will also add the "HammerSlope" and "HammerWall" ToolTypes to the tool, with the same tool power.
		}
