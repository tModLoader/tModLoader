...
namespace ExampleMod.Content.NPCs
{
	...
	{
		// This is a reference property. It lets us write AI_State as if it's NPC.ai[0], essentially giving it our own name.
		// It helps to keep our AI code clear of clutter. Without it, every instance of "AI_State" in the AI code below would be "npc.ai[0]".
		...
		// Our texture is 32x32 with 2 pixels of padding vertically, so 34 is the vertical spacing.
		// These are for my benefit and the numbers could easily be used directly in the code below, but this is how we keep code organized.
		private enum Frame
		{
			Asleep,
			Notice,
