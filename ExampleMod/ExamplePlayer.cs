...
namespace ExampleMod
{
	...
	public class ExamplePlayer : ModPlayer
	{
		...
		public static readonly PlayerLayer ExampleBreastplateBodyGlowmask = new PlayerLayer("ExampleMod", "ExampleBreastplateBodyGlowmask", PlayerLayer.Body, delegate (PlayerDrawInfo drawInfo) {
		...
		public static readonly PlayerLayer ExampleBreastplateArmsGlowmask = new PlayerLayer("ExampleMod", "ExampleBreastplateArmsGlowmask", PlayerLayer.Arms, delegate (PlayerDrawInfo drawInfo) {
			...
			Texture2D texture = mod.GetTexture("Items/Armor/ExampleBreastplate_Arms_Glowmask");
		...
		public override void ModifyDrawLayers(List<PlayerLayer> layers) {
			...
			if (bodyLayer > -1) {
				...
				layers.Insert(bodyLayer + 1, ExampleBreastplateBodyGlowmask);
				...
				if (armsLayer > -1) {
					layers.Insert(armsLayer + 1, ExampleBreastplateArmsGlowmask);
				}
			}
