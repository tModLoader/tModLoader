...
namespace ExampleMod.Projectiles
{
	...
	class ExampleExplosive : ModProjectile
	{
		public override void SetDefaults()
		{
			...
			// sticky only? how? projectile.tileCollide = false;

			drawOffsetX = 5; // TODO document why projectile.
			drawOriginOffsetY = 5;

			projectile.timeLeft = 300; // 5 second timer.
		}

		public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
		{
			// Vanilla explisions do less damage to Eater of Worlds for some reason, so we will too.
			if (Main.expertMode)
			{
