...
namespace ExampleMod.Common.Configs
{
	public class ExampleModConfig : ModConfig
	{
		...
		[Header] // A label is the text displayed next to the option. This should usually be a short description of what it does. By default all ModConfig fields and properties have an automatic label translation key, but modders can specify a specific translation key.
		// [Label("Some.Key")] // A tooltip is a description showed when you hover your mouse over the option. It can be used as a more in-depth explanation of the option. Like with Label, a specific key can be provided. Unlike Label, ModConfig fields and properties are not assumed to have tooltips.
		[Tooltip]
