...
{
	// This example, like ExampleFullscreenUI.cs, modifies a loaded ModConfig. This example simply shows that calling ModConfig.SaveChanges on the server for ServerSide configs also works. (Since this command is CommandType.World, it runs on the server in multiplayer.) 
