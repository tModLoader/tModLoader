...
namespace ExampleMod.Common.GlobalNPCs
{
	...
	{
		public override int PickEmote(NPC npc, Player closetPlayer, List<int> emoteList, WorldUIAnchor otherAnchor) {
			...
			if (Main.rand.NextBool(2) && ModContent.GetInstance<ExampleSurfaceBiome>().IsBiomeActive(closetPlayer))
			...
			return base.PickEmote(npc, closetPlayer, emoteList, otherAnchor);
		}
	}
}
