...
namespace Terraria.ModLoader
{
	partial class Mod
	{
		...
		internal readonly IDictionary<string, Texture2D> textures = new Dictionary<string, Texture2D>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, SoundEffect> sounds = new Dictionary<string, SoundEffect>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, Music> musics = new Dictionary<string, Music>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, DynamicSpriteFont> fonts = new Dictionary<string, DynamicSpriteFont>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, Effect> effects = new Dictionary<string, Effect>(StringComparer.OrdinalIgnoreCase);
		internal readonly IList<ModRecipe> recipes = new List<ModRecipe>();
		internal readonly IDictionary<string, ModItem> items = new Dictionary<string, ModItem>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, GlobalItem> globalItems = new Dictionary<string, GlobalItem>(StringComparer.OrdinalIgnoreCase);
		...
		internal readonly IDictionary<string, ModPrefix> prefixes = new Dictionary<string, ModPrefix>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModDust> dusts = new Dictionary<string, ModDust>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModTile> tiles = new Dictionary<string, ModTile>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, GlobalTile> globalTiles = new Dictionary<string, GlobalTile>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModTileEntity> tileEntities = new Dictionary<string, ModTileEntity>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModWall> walls = new Dictionary<string, ModWall>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, GlobalWall> globalWalls = new Dictionary<string, GlobalWall>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModProjectile> projectiles = new Dictionary<string, ModProjectile>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, GlobalProjectile> globalProjectiles = new Dictionary<string, GlobalProjectile>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModNPC> npcs = new Dictionary<string, ModNPC>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, GlobalNPC> globalNPCs = new Dictionary<string, GlobalNPC>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModPlayer> players = new Dictionary<string, ModPlayer>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModMountData> mountDatas = new Dictionary<string, ModMountData>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModBuff> buffs = new Dictionary<string, ModBuff>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, GlobalBuff> globalBuffs = new Dictionary<string, GlobalBuff>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModWorld> worlds = new Dictionary<string, ModWorld>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModUgBgStyle> ugBgStyles = new Dictionary<string, ModUgBgStyle>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModSurfaceBgStyle> surfaceBgStyles = new Dictionary<string, ModSurfaceBgStyle>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, GlobalBgStyle> globalBgStyles = new Dictionary<string, GlobalBgStyle>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModWaterStyle> waterStyles = new Dictionary<string, ModWaterStyle>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModWaterfallStyle> waterfallStyles = new Dictionary<string, ModWaterfallStyle>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, GlobalRecipe> globalRecipes = new Dictionary<string, GlobalRecipe>(StringComparer.OrdinalIgnoreCase);
		internal readonly IDictionary<string, ModTranslation> translations = new Dictionary<string, ModTranslation>(StringComparer.OrdinalIgnoreCase);
