	...
	internal static class InstallVerifier
	{
		...
		static InstallVerifier()
		{
			if (Platform.IsWindows) {
				...
				gogHash = ToByteArray("56d1bee030a5cc5a365574eaa0a79030"); // Don't forget to update CheckExe in CheckGoG
				steamHash = ToByteArray("890f5654041f09607d74596d46249000");
			}
			else if (Platform.IsOSX) {
				steamAPIPath = "osx/libsteam_api.dylib";
				steamAPIHash = ToByteArray("4EECD26A0CDF89F90D4FF26ECAD37BE0");
				gogHash = ToByteArray("a2182f5036c7925ea68b3f04e0bb77a3");
				steamHash = ToByteArray("265a011c6b866292c444f12d20e2039a");
			}
			else if (Platform.IsLinux) {
				steamAPIPath = "lib/libsteam_api.so";
				steamAPIHash = ToByteArray("7B74FD4C207D22DB91B4B649A44467F6");
				gogHash = ToByteArray("ed920c5c5bcb4631afeb2061c0529d9b");
				steamHash = ToByteArray("c3a110a86c5948a7beeb84e3f1a34149");
			}
			else {
		...
		private static bool CheckGoG()
		{
			...
			string CheckExe = $"Terraria_1.4.5.8.exe"; // This should match the hashes. {Main.versionNumber}
