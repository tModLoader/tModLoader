...
namespace Terraria.DataStructures
{
	public partial class PlayerDrawLayers
	{
		...
		public static readonly Transformation TorsoGroup = new LegacyPlayerDrawTransform(DrawPlayer_extra_TorsoPlus, DrawPlayer_extra_TorsoMinus);
		
		/// <summary> Adds <see cref="PlayerDrawSet.mountOffSet"/>/2 to <see cref="PlayerDrawSet.Position"/> vector's Y axis. </summary>
		public static readonly Transformation MountGroup = new LegacyPlayerDrawTransform(DrawPlayer_extra_MountPlus, DrawPlayer_extra_MountMinus, TorsoGroup);
		...
		public static readonly PlayerDrawLayer FrontAccFront = new LegacyPlayerDrawLayer(nameof(FrontAccFront), DrawPlayer_32_FrontAcc_FrontPart,
		...
		public static readonly PlayerDrawLayer HeldItem = new LegacyPlayerDrawLayer(nameof(HeldItem), DrawPlayer_27_HeldItem,
			position: new Multiple() {
