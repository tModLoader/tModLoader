namespace Terraria.GameContent.UI.BigProgressBar
{
	public partial class BigProgressBarSystem
	{
		...
		/// <para> Reminder: If no special or modded bar exists, any NPC with a boss head index will automatically display a common boss bar shared among all simple bosses.</para>
		/// </summary>
