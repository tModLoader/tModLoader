...
partial class MinimapFrameManager
{
	...
	public string ActiveSelectionDisplayName =>
		ModContent.TryFind<ModMinimapFrame>(ActiveSelectionConfigKey, out ModMinimapFrame frame) ? frame.DisplayName.Value : Language.GetTextValue("UI.MinimapFrame_" + ActiveSelectionKeyName);
