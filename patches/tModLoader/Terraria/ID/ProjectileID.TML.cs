...
partial class ProjectileID
{
	partial class Sets
	{
		...
		/// <para/> Explosives also bounce off the top of Shimmer, detonate with no blast damage when touching the bottom or sides of Shimmer, and use the shared player blast damage path when killed, including For the Worthy worlds.
		/// <para/> Custom AI explosives using this set should call <see cref="Projectile.PrepareBombToBlow"/> shortly before dying and use <see cref="ModLoader.ModProjectile.PrepareBombToBlow"/> to adjust the blast hitbox, damage, and knockback.
