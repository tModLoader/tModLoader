...
public partial class NPCID
{
	public static partial class Sets
	{
		...
		/// By default, NPCs aren't immune to any buffs, but <see cref="DefaultDebuffImmunity"/> or <see cref="FullyImmuneToBuffs"/> can make an NPC immune to all buffs. The values in this set override those settings.<br/><br/>
