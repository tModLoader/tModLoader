...
{
	internal class LegacyUnloadedTileInfo
	{
		...
		public LegacyUnloadedTileInfo(string modName, string name) {
		...
		public LegacyUnloadedTileInfo(string modName, string name, short frameX, short frameY) {
			this.modName = modName;
			this.name = name;
		...
		public override bool Equals(object obj) {
			LegacyUnloadedTileInfo other = obj as LegacyUnloadedTileInfo;
			if (other == null) {
				return false;
			}
