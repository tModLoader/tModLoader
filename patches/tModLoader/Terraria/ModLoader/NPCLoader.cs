...
namespace Terraria.ModLoader
{
	...
	public static class NPCLoader
	{
		...
		*/
		...
		private delegate bool DelegateModifyCollisionData(NPC npc, Rectangle victimHitbox, ref float damageMultiplier, ref Rectangle npcHitbox);
		private static HookList HookModifyCollisionData = AddHook<DelegateModifyCollisionData>(g => g.ModifyCollisionData);

		public static bool ModifyCollisionData(NPC npc, Rectangle victimHitbox, ref float damageMultiplier, ref Rectangle npcHitbox) {
			bool result = true;
			...
			if (result && npc.ModNPC != null) {
				result = npc.ModNPC.ModifyCollisionData(victimHitbox, ref damageMultiplier, ref npcHitbox);
			}
