...
{
	public readonly void Send(ModPacket packet, int value) => packet.Write7BitEncodedInt(value);
...
{
	public readonly void Send(ModPacket packet, long value) => packet.Write7BitEncodedInt64(value);
...
{
	public readonly void Send(ModPacket packet, T value)
	{
...
{
	public readonly void Send(ModPacket packet, Vector2 value) => packet.WriteVector2(value);
...
{
	public readonly void Send(ModPacket packet, Vector2 value) => packet.WritePackedVector2(value);
...
{
	public readonly void Send(ModPacket packet, Color value) => packet.Write(value.PackedValue);
...
{
	public readonly void Send(ModPacket packet, Color value) => packet.WriteRGB(value);
	public readonly Color Read(BinaryReader reader) => reader.ReadRGB();
}
#endregion

#region Array and List
public readonly struct ArrayEncoder<TType, TEncoder> : INetEncoder<TType[]> where TEncoder : struct, INetEncoder
{
	public readonly void Send(ModPacket packet, TType[] value)
	{
		packet.Write7BitEncodedInt64(value.LongLength);

		var encoder = default(TEncoder);
		foreach (var element in value.AsSpan()) {
			encoder.Send(packet, element);
		}
	}
...
public readonly struct ListEncoder<TType, TEncoder> : INetEncoder<List<TType>> where TEncoder : struct, INetEncoder
{
	public readonly void Send(ModPacket packet, List<TType> value)
	{
...
{
	public readonly void Send(ModPacket packet, Span<TType> value)
	{
		packet.Write7BitEncodedInt(value.Length);
		packet.Write(MemoryMarshal.AsBytes(value));
	}

	public readonly Span<TType> Read(BinaryReader reader)
	{
		int length = reader.Read7BitEncodedInt();
		return MemoryMarshal.Cast<byte, TType>(new Span<byte>(reader.ReadBytes(length)));
	}
}

public readonly struct ReadOnlySpanEncoder<TType, TEncoder> where TType : struct where TEncoder : INetEncoder
{
	public readonly void Send(ModPacket packet, ReadOnlySpan<TType> value)
	{
		packet.Write7BitEncodedInt(value.Length);
		packet.Write(MemoryMarshal.AsBytes(value));
	}

	public readonly ReadOnlySpan<TType> Read(BinaryReader reader)
	{
		int length = reader.Read7BitEncodedInt();
		return MemoryMarshal.Cast<byte, TType>(new ReadOnlySpan<byte>(reader.ReadBytes(length)));
	}
}
#endregion
...
{
	public readonly void Send(ModPacket packet, ValueTuple<T1_0> value) => default(T1_1).Send(packet, value.Item1);
...
{
	public readonly void Send(ModPacket packet, (T1_0, T2_0) value)
	{
		default(T1_1).Send(packet, value.Item1);
		default(T2_1).Send(packet, value.Item2);
	}
...
{
	public readonly void Send(ModPacket packet, (T1_0, T2_0, T3_0) value)
	{
		default(T1_1).Send(packet, value.Item1);
		default(T2_1).Send(packet, value.Item2);
		default(T3_1).Send(packet, value.Item3);
	}
...
{
	public readonly void Send(ModPacket packet, (T1_0, T2_0, T3_0, T4_0) value)
	{
		default(T1_1).Send(packet, value.Item1);
		default(T2_1).Send(packet, value.Item2);
		default(T3_1).Send(packet, value.Item3);
		default(T4_1).Send(packet, value.Item4);
	}
...
{
	public readonly void Send(ModPacket packet, (T1_0, T2_0, T3_0, T4_0, T5_0) value)
	{
		default(T1_1).Send(packet, value.Item1);
		default(T2_1).Send(packet, value.Item2);
		default(T3_1).Send(packet, value.Item3);
		default(T4_1).Send(packet, value.Item4);
		default(T5_1).Send(packet, value.Item5);
	}
...
{
	public readonly void Send(ModPacket packet, (T1_0, T2_0, T3_0, T4_0, T5_0, T6_0) value)
	{
		default(T1_1).Send(packet, value.Item1);
		default(T2_1).Send(packet, value.Item2);
		default(T3_1).Send(packet, value.Item3);
		default(T4_1).Send(packet, value.Item4);
		default(T5_1).Send(packet, value.Item5);
		default(T6_1).Send(packet, value.Item6);
	}
...
{
	public readonly void Send(ModPacket packet, (T1_0, T2_0, T3_0, T4_0, T5_0, T6_0, T7_0) value)
	{
		default(T1_1).Send(packet, value.Item1);
		default(T2_1).Send(packet, value.Item2);
		default(T3_1).Send(packet, value.Item3);
		...
		default(T5_1).Send(packet, value.Item5);
		default(T6_1).Send(packet, value.Item6);
		default(T7_1).Send(packet, value.Item7);
	}
...
{
	public readonly void Send(ModPacket packet, (T1_0, T2_0, T3_0, T4_0, T5_0, T6_0, T7_0, T8_0) value)
	{
		default(T1_1).Send(packet, value.Item1);
		default(T2_1).Send(packet, value.Item2);
		default(T3_1).Send(packet, value.Item3);
		...
		default(T6_1).Send(packet, value.Item6);
		default(T7_1).Send(packet, value.Item7);
		default(T8_1).Send(packet, value.Item8);
	}
