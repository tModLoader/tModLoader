...
namespace Terraria.ModLoader
{
	...
	public abstract class ModNPC : ModTexturedType
	{
		...
		/// If this returns false, <see cref="GlobalNPC.OnCatchNPC"/> and <see cref="OnCatchNPC"/> are never called.<br></br><br></br>
		...
		/// <summary>
		/// Allows you to make things happen when this NPC is successfully caught by an NPC-catching tool, such as a bug net.
		/// </summary>
