...
namespace Terraria.ModLoader
{
	public abstract class BuilderToggle : ModTexturedType
	{
		...
		/// </summary>
		/// <value>Default NumberOfStates is 2</value>
		public virtual int NumberOfStates => 2;

		/// <summary>
		/// This is the current state of this BuilderToggle. Every time the toggle is clicked, it will change.
		/// </summary>
		public virtual int CurrentState { get; internal set; }

		/// <summary>
		/// Cycles through the possible states one at a time.
		/// </summary>
		/// <returns>Returns the value of the new <see cref="CurrentState"/></returns>
		internal int IncreaseCurrentState() => CurrentState = (CurrentState + 1) % NumberOfStates;
