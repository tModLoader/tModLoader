...
public abstract class ConfigElement : UIElement
{
	...
	public virtual void OnBind()
	{
		...
		Label = ConfigManager.GetLocalizedText<LabelKeyAttribute, LabelArgsAttribute>(MemberInfo, "Label", defaultToNull: false);
		...
		string tooltip = ConfigManager.GetLocalizedText<TooltipKeyAttribute, TooltipArgsAttribute>(MemberInfo, "Tooltip", defaultToNull: true);
		if (tooltip != null) {
