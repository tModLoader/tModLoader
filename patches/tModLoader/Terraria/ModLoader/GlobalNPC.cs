...
namespace Terraria.ModLoader
{
	...
	public abstract class GlobalNPC : ModType
	{
		...
		/// <summary>
		/// Allows you to determine whether an NPC can be hit by the given melee weapon when swung. Return true to allow hitting the NPC, return false to block hitting the NPC. Returns true by default.
		/// </summary>
		/// <param name="npc"></param>
