...
public abstract class GlobalNPC : GlobalType<NPC, GlobalNPC>
{
	...
	/// <summary>
	/// Allows you to make things happen when an NPC dies (for example, setting ModSystem fields). For client-side effects, such as dust, gore, and sounds, see <see cref="HitEffect(NPC, NPC.HitInfo)"/>.
	...
	/// Be aware that this hook is called just one time during loading.<br/>
	/// <b>NOTE:</b> The Traveling Merchant shop is handled separately in <see cref="SetupTravelShop(int[], ref int)"/>.
	/// </summary>
