...
$@"<Project ToolsVersion=""14.0"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">
  <Import Project=""{SecurityElement.Escape(tMLModTargetsPath)}"" />
			...
			UpdateFileContents(tMLModTargetsPath, 
$@"<Project ToolsVersion=""14.0"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">
	<PropertyGroup>
		<!-- legacy property -->
	...
	<Target Name=""BuildMod"" AfterTargets=""Build"">
		<Exec Command=""dotnet $(tMLServerPath) -build $(ProjectDir) -eac $(TargetPath) -define $(DefineConstants) -unsafe $(AllowUnsafeBlocks)"" WorkingDirectory=""$(tMLSteamPath)""/>
	</Target>
</Project>");
