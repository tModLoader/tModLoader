...
public abstract class ModWall : ModBlockType
{
	...
	/// <br/> The <paramref name="type"/> passed in is the item type of the loaded item with <see cref="Item.createWall"/> matching the type of this Wall. If <see cref="ModBlockType.ItemDropOverride"/> is set, it will override that value.
	/// </summary>
