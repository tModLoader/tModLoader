...
namespace Terraria.ModLoader
{
	...
	public abstract class ModWall : ModTexturedType
	{
		...
		/// <summary>
		/// Whether a tool that has a given ToolType can be used on this wall. Returns null by default (follow vanilla behavior).
		/// </summary>
		...
		/// <summary>
		/// Allows you to modify the damage taken by this wall when an item with a specific ToolType is used on it.
		/// </summary>
		/// <param name="i"> The x position in tile coordinates. </param>
		/// <param name="j"> The y position in tile coordinates. </param>
		/// <param name="item"> The item being used. </param>
