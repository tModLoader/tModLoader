...
/// </summary>
public static class DataInstance<T>
{
	/// <summary> Stores the data. </summary>
	private static ConcurrentDictionary<object, T> data = new ConcurrentDictionary<object, T>();
	...
	*/
	...
	/// </summary>
	public static void GetOrAdd(object key, ref T obj)
	{
		T entry = data.GetOrAdd(key, obj);
		obj = entry;
	}
	...
	/// </summary>
	public static void Expose(Mod mod, string key, T entry)
	{
	...
	/// </summary>
	public static T Retrieve(string modName, string key) => Retrieve($"{modName}/{key}");
	...
	/// </summary>
	public static T Retrieve(Mod mod, string key) => Retrieve($"{mod.Name}/{key}");
}
