...
/// <para/> <see cref="EquipType.Coat"/> additionally autoloads optional lower extension textures by appending <c>_Coat_Front</c> and <c>_Coat_Back</c>. These textures use the <see cref="EquipType.Legs"/> layout and draw over, rather than replace, the player's leg armor.
/// </summary>
