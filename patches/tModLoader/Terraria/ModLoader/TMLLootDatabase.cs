...
namespace Terraria.ModLoader
{
	...
	// TODO: Travelling Merchant shop, apply 1.4.4 changes to shops.
	public class TMLLootDatabase
	{
		private readonly Dictionary<int, ChestLoot> npcShopByType = new();
		private readonly List<ChestLoot.Entry> globalNpcShopEntries = new();
		...
		private void RegisterTravellingMerchant() {
			ChestLoot shop = new(); // no idea how to do it here tbh, so i will leave it empty for now
			RegisterNpcShop(19, shop);
		}
