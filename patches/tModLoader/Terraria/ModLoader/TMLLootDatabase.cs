...
namespace Terraria.ModLoader
{
	...
	public class TMLLootDatabase
	{
		...
		public LootTable TravellingMerchantEntries;
		...
		public void Initialize() {
			...
			NPCLoader.SetupTravelShop(TravellingMerchantEntries);
			TravellingMerchantEntries.CalculateWeight();

			for (int i = 0; i < NPCLoader.NPCCount; i++) {
				ChestLoot chest = new();
				bool flag = false;
				if (npcShopByType.TryGetValue(i, out ChestLoot chestLoot)) {
					chest = chestLoot;
					flag = true;
				}
		...
		private void RegisterTravellingMerchant() {
			const int r0 = 6;
			const int r1 = 5;
			const int r2 = 4;
			const int r3 = 3;
			...
			TravellingMerchantEntries = new LootTable() {
				new LootTablePool() {
					new PoolEntry(3309, r4),
					new PoolEntry(3314, r3),
					new PoolEntry(1987, r5),

					new PoolEntry(2270, r4, onRoll: () => Main.hardMode ? null : false),
					new PoolEntry(4760, r4, onRoll: () => Main.hardMode ? null : false),
					new PoolEntry(2278, r4),
					new PoolEntry(2271, r4),

					new PoolEntry(2223, r3, onRoll: () => (Main.hardMode && NPC.downedMechBoss1 && NPC.downedMechBoss2 && NPC.downedMechBoss3) ? null : false),
					new PoolEntry(2272, r3),
					new PoolEntry(2276, r3),
					new PoolEntry(2284, r3),
					new PoolEntry(2285, r3),
					new PoolEntry(2286, r3),
					new PoolEntry(2287, r3),
					new PoolEntry(4744, r3),
					new PoolEntry(2296, r3, onRoll: () => NPC.downedBoss3 ? null : false),
					new PoolEntry(3628, r3),
					new PoolEntry(4091, r3, onRoll: () => Main.hardMode ? null : false),
					new PoolEntry(4603, r3),
					new PoolEntry(4604, r3),
					new PoolEntry(5297, r3),
					new PoolEntry(4605, r3),
					new PoolEntry(4550, r3),

					new PoolEntry(2268, r2),
					new PoolEntry(2269, r2, onRoll: () => WorldGen.shadowOrbSmashed ? null : false),
					new PoolEntry(1988, r2),
					new PoolEntry(2275, r2),
					new PoolEntry(2279, r2),
					new PoolEntry(2277, r2),
					new PoolEntry(4555, r0).Then(new PoolEntry(4556, 1)).Then(new PoolEntry(4557, 1)),
					new PoolEntry(4321, r2).Then(new PoolEntry(4322, 1)),
					new PoolEntry(4323, r2).Then(new PoolEntry(4324, 1)).Then(new PoolEntry(4365, 1)),
					new PoolEntry(5390, r2).Then(new PoolEntry(5386, 1)).Then(new PoolEntry(5387, 1)),
					new PoolEntry(4549, r2),
					new PoolEntry(4561, r2),
					new PoolEntry(4774, r2),
					new PoolEntry(5136, r2),
					new PoolEntry(5305, r2),
					new PoolEntry(4562, r2),
					new PoolEntry(4558, r2),
					new PoolEntry(4559, r2),
					new PoolEntry(4563, r2),
					new PoolEntry(4666, r2).Then(new PoolEntry(4664, 1)).Then(new PoolEntry(4665, 1)),
					new PoolEntry(4347, r2, onRoll: () => (!Main.hardMode && (NPC.downedBoss1 || NPC.downedBoss2 || NPC.downedBoss3 || NPC.downedQueenBee)) ? null : false),
					new PoolEntry(4348, r2, onRoll: () => (Main.hardMode && (NPC.downedBoss1 || NPC.downedBoss2 || NPC.downedBoss3 || NPC.downedQueenBee)) ? null : false),
					new PoolEntry(3262, r2, onRoll: () => NPC.downedBoss1 ? null : false),
					new PoolEntry(3284, r2, onRoll: () => NPC.downedMechBossAny ? null : false),

					new PoolEntry(2267, r1),
					new PoolEntry(2214, r1),
					new PoolEntry(2215, r1),
					new PoolEntry(2216, r1),
					new PoolEntry(2217, r1),
					new PoolEntry(3624, r1),
					new PoolEntry(671, r1, onRoll: () => Main.remixWorld ? null : false),
					new PoolEntry(2273, r1, onRoll: () => !Main.remixWorld ? null : false),
					new PoolEntry(2274, r1),

					new PoolEntry(2266, r0),
					new PoolEntry(2281, r0),
					new PoolEntry(2282, r0),
					new PoolEntry(2283, r0),
					new PoolEntry(2258, r0),
					new PoolEntry(2242, r0),
					new PoolEntry(2260, r0).Then(new PoolEntry(2261, 1)).Then(new PoolEntry(2262, 1)),
					new PoolEntry(3637, r0),
					new PoolEntry(4420, r0),
					new PoolEntry(3119, r0),
					new PoolEntry(3118, r0),
					new PoolEntry(3099, r0),
				},
				new LootTablePool() {
					new PoolEntry(5121, r3, onRoll: () => !Main.dontStarveWorld ? null : false),
					new PoolEntry(5122, r3, onRoll: () => !Main.dontStarveWorld ? null : false),
					new PoolEntry(5124, r3, onRoll: () => !Main.dontStarveWorld ? null : false),
					new PoolEntry(5123, r3, onRoll: () => !Main.dontStarveWorld ? null : false),

					new PoolEntry(3596, r2, onRoll: () => (Main.hardMode && NPC.downedMoonlord) ? null : false),
					new PoolEntry(2865, r2, onRoll: () => (Main.hardMode && NPC.downedMartians) ? null : false),
					new PoolEntry(2866, r2, onRoll: () => (Main.hardMode && NPC.downedMartians) ? null : false),
					new PoolEntry(2867, r2, onRoll: () => (Main.hardMode && NPC.downedMartians) ? null : false),
					new PoolEntry(3055, r2, onRoll: () => NPC.downedFrost ? null : false),
					new PoolEntry(3056, r2, onRoll: () => NPC.downedFrost ? null : false),
					new PoolEntry(3057, r2, onRoll: () => NPC.downedFrost ? null : false),
					new PoolEntry(3058, r2, onRoll: () => NPC.downedFrost ? null : false),
					new PoolEntry(3059, r2, onRoll: () => NPC.downedFrost ? null : false),
					new PoolEntry(5243, r2, onRoll: () => (Main.hardMode && NPC.downedMoonlord) ? null : false),

					new PoolEntry(5121, r1, onRoll: () => Main.dontStarveWorld ? null : false),
					new PoolEntry(5122, r1, onRoll: () => Main.dontStarveWorld ? null : false),
					new PoolEntry(5124, r1, onRoll: () => Main.dontStarveWorld ? null : false),
					new PoolEntry(5123, r1, onRoll: () => Main.dontStarveWorld ? null : false),
					new PoolEntry(5225, r1),
					new PoolEntry(5229, r1),
					new PoolEntry(5232, r1),
					new PoolEntry(5389, r1),
					new PoolEntry(5233, r1),
					new PoolEntry(5241, r1),
					new PoolEntry(5244, r1),
					new PoolEntry(5242, r1),
				}
			};
		}
