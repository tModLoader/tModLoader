...
public partial class WorldGen
{
	...
	public static bool AddBuriedChest(Microsoft.Xna.Framework.Point point, string pool, bool notNearOtherChests = false, int Style = -1, int forceContain = ItemID.None) => AddBuriedChest(point.X, point.Y, pool, notNearOtherChests, Style, trySlope: false, 0, forceContain);
	/// <summary>
