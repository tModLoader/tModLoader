...
public readonly partial struct Tile
{
	...
	internal void water(bool water) => SetIsLiquidType(LiquidID.Water, water);
	...
	internal bool anyWater() => liquid > 0 && water();

	internal bool anyLava() => liquid > 0 && lava();

	internal bool anyHoney() => liquid > 0 && honey();

	internal bool anyShimmer() => liquid > 0 && shimmer();
	...
	internal bool anyWire() => Get<TileWallWireStateData>().WireData != 0;
