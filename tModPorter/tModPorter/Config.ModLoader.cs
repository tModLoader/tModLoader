...
public static partial class Config
{
	private static void AddModLoaderRefactors() {
		...
		ChangeHookSignature("Terraria.ModLoader.InfoDisplay", "DisplayValue", comment: "Suggestion: Set displayColor to inactiveColor if your display value is \"zero\"/shows no valuable information");
	}
}
