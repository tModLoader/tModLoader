...
public static partial class Config
{
	private static void AddModLoaderRefactors() {
		...
		*/
		...
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "desertCave",			to: "spawnUndergroundDesert");
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "granite",				to: "nearGranite");
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "invasion",			to: "invaders");
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "lihzahrd",			to: "ZoneLihzhardTemple");
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "marble",				to: "nearMarble");
		...
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "playerInTown",		to: "spawnFriendly");
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "playerSafe",			to: "noWorms");
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "safeRangeX",			to: "SafeRangeX");
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "sky",					to: "skyMob");
		...
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "spiderCave",			to: "spawnSpider");
		RenameInstanceField("Terraria.ModLoader.NPCSpawnInfo", from: "water",				to: "waterTile");
		...
		RenameInstanceField("Terraria.NPC.Spawner", from: "planteraDefeated",	to: "PlanteraDefeated");
		RenameInstanceField("Terraria.NPC.Spawner", from: "player",				to: "Player");
		RenameInstanceField("Terraria.NPC.Spawner", from: "playerFloorX",		to: "PlayerFloorX");
		RenameInstanceField("Terraria.NPC.Spawner", from: "playerFloorY",		to: "PlayerFloorY");
