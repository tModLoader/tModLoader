...
namespace Terraria.ModLoader.Setup.GUI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent() {
            ...
            this.toolTipButtons.SetToolTip(this.buttonSetup, "Complete environment setup for working on Unified source\r\nEquivalent to Decomp" +
        "ile+Patch+SetupDebug\r\nEdit the source in src/Unified then run Diff Unified" +
        ...
        "source is located in src/Terraria");
            ...
            this.buttonPatchModLoader.Text = "Patch Unified";
            this.toolTipButtons.SetToolTip(this.buttonPatchModLoader, "Applies Unified patches to Terraria\r\nEdit the source code in src/Unified af" +
        "ter this phase\r\nInternally formats the Terraria sources before patching");
            ...
            this.buttonDiffModLoader.Text = "Diff Unified";
